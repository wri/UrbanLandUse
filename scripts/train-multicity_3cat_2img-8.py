...
TRAIN_DS=f'{DATASETS_DIR}/multi_city_2img-8-train.csv'
VALID_DS=f'{DATASETS_DIR}/multi_city_2img-2-valid.csv'
...
#
# TODO: MOVE BEFORE PREDICTIONS AFTER EACH TRAINING LOAD MODEL FIRST
#
